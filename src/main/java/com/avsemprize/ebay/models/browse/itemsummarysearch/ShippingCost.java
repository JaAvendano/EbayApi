...
public class ShippingCost {
    ...
    public ShippingCost withConvertedFromCurrency(String convertedFromCurrency) {
        this.convertedFromCurrency = convertedFromCurrency;
        return this;
    }
    ...
    public ShippingCost withConvertedFromValue(String convertedFromValue) {
        this.convertedFromValue = convertedFromValue;
        return this;
    }
    ...
    public ShippingCost withCurrency(String currency) {
        this.currency = currency;
        return this;
    }
    ...
    public ShippingCost withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ShippingCost.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ShippingCost) == false) {
            return false;
        }
        ShippingCost rhs = ((ShippingCost) other);
