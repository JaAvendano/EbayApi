...
public class OriginalPrice {
    ...
    public OriginalPrice withConvertedFromCurrency(String convertedFromCurrency) {
        this.convertedFromCurrency = convertedFromCurrency;
        return this;
    }
    ...
    public OriginalPrice withConvertedFromValue(String convertedFromValue) {
        this.convertedFromValue = convertedFromValue;
        return this;
    }
    ...
    public OriginalPrice withCurrency(String currency) {
        this.currency = currency;
        return this;
    }
    ...
    public OriginalPrice withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(OriginalPrice.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof OriginalPrice) == false) {
            return false;
        }
        OriginalPrice rhs = ((OriginalPrice) other);
