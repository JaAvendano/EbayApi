...
public class CurrentBidPrice {
    ...
    public CurrentBidPrice withConvertedFromCurrency(String convertedFromCurrency) {
        this.convertedFromCurrency = convertedFromCurrency;
        return this;
    }
    ...
    public CurrentBidPrice withConvertedFromValue(String convertedFromValue) {
        this.convertedFromValue = convertedFromValue;
        return this;
    }
    ...
    public CurrentBidPrice withCurrency(String currency) {
        this.currency = currency;
        return this;
    }
    ...
    public CurrentBidPrice withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CurrentBidPrice.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CurrentBidPrice) == false) {
            return false;
        }
        CurrentBidPrice rhs = ((CurrentBidPrice) other);
