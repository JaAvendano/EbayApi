...
public class ThumbnailImage {
    ...
    public ThumbnailImage withHeight(String height) {
        this.height = height;
        return this;
    }
    ...
    public ThumbnailImage withImageUrl(String imageUrl) {
        this.imageUrl = imageUrl;
        return this;
    }
    ...
    public ThumbnailImage withWidth(String width) {
        this.width = width;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ThumbnailImage.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("height");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ThumbnailImage) == false) {
            return false;
        }
        ThumbnailImage rhs = ((ThumbnailImage) other);
